...
Gem::Specification.new do |spec|
  ...
  spec.add_runtime_dependency "metanorma-ietf", "~> 3.1.0"
  spec.add_runtime_dependency "metanorma-iso", "~> 2.3.0"
  spec.add_runtime_dependency "mnconvert"
  spec.add_runtime_dependency "thor", "~> 1.0"
  # spec.add_runtime_dependency "metanorma-gb", "~> 1.5.0"
  spec.add_runtime_dependency "metanorma-cc", "~> 2.2.0"
  spec.add_runtime_dependency "metanorma-csa", "~> 2.2.0"
  spec.add_runtime_dependency "metanorma-iec", "~> 2.2.0"
  # spec.add_runtime_dependency 'metanorma-ribose', "~> 2.1.0"
  spec.add_runtime_dependency "metanorma-bipm", "~> 2.2.0"
  spec.add_runtime_dependency "metanorma-generic", "~> 2.3.0"
  spec.add_runtime_dependency "metanorma-m3aawg", "~> 2.2.0"
  spec.add_runtime_dependency "metanorma-standoc", "~> 2.3.0"
  # spec.add_runtime_dependency 'metanorma-mpfa', "~> 0.9.0"
  spec.add_runtime_dependency "git", "~> 1.5"
  spec.add_runtime_dependency "isodoc", ">= 2.4.0"
  spec.add_runtime_dependency "metanorma", "~> 1.5.0"
  spec.add_runtime_dependency "metanorma-iho", "~> 0.7.0"
  spec.add_runtime_dependency "metanorma-itu", "~> 2.2.0"
  # spec.add_runtime_dependency "metanorma-nist", "~> 2.1.0"
  spec.add_runtime_dependency "metanorma-ieee", "~> 1.0.0"
  spec.add_runtime_dependency "metanorma-ogc", "~> 2.3.0"
  spec.add_runtime_dependency "metanorma-un", "~> 0.10.0"
