...
Gem::Specification.new do |spec|
  ...
  spec.add_runtime_dependency "metanorma-iso", "~> 2.2.0"
  spec.add_runtime_dependency "mnconvert"
  spec.add_runtime_dependency "thor", "~> 1.0"
  # spec.add_runtime_dependency "metanorma-gb", "~> 1.5.0"
  spec.add_runtime_dependency "metanorma-cc", "~> 2.1.0"
  spec.add_runtime_dependency "metanorma-csa", "~> 2.1.0"
  spec.add_runtime_dependency "metanorma-iec", "~> 2.1.0"
  # spec.add_runtime_dependency 'metanorma-ribose', "~> 2.1.0"
  spec.add_runtime_dependency "metanorma-bipm", "~> 2.1.0"
  spec.add_runtime_dependency "metanorma-generic", "~> 2.2.2"
  spec.add_runtime_dependency "metanorma-m3aawg", "~> 2.1.0"
  spec.add_runtime_dependency "metanorma-standoc", "~> 2.2.4"
  # spec.add_runtime_dependency 'metanorma-mpfa', "~> 0.9.0"
  spec.add_runtime_dependency "git", "~> 1.5"
  spec.add_runtime_dependency "isodoc", ">= 2.2.0"
